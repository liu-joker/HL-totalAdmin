    ...
    <div class="CM_content_center">
      <template>
        <el-table :data="tableData" border stripe style="width: 100%" id="TQ_table">
          ...
          <el-table-column prop="webName" label="标签" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="类型" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="展示开始时间" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="展示结束时间" align="center">
          </el-table-column>
