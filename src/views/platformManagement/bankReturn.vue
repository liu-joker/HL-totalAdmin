        ...
        <el-row type="flex" class="row-bg">
          ...
          <el-col :sm="6">
            <el-form-item label="启用状态:" prop="name">
              <el-select v-model="eventType" clearable placeholder="启用状态" size="small" style="width: 200px">
        ...
        <el-row>
          ...
          <el-col :sm="4">
            <el-button-group>
              ...
              <el-button type="" size="mini"  icon='el-icon-edit'>修改</el-button>
    ...
    <div class="CM_content_center">
      <template>
        <el-table :data="tableData" border stripe style="width: 100%" id="TQ_table">
          ...
          <el-table-column prop="webName" label="银行编号" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="银行返回码" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="银行返回信息" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="自定义返回信息" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="备注" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="启用状态" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="更新时间" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="创建时间" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="创建人" align="center">
          </el-table-column>
