<template>
  <div>
      <div class="header" style='margin-bottom:20px;'>
        ...
        <!-- <el-col :sm="8">
          <el-form-item label="参数显示名称:" prop="name"
                     >
        ...
        <el-form-item label="结束时间:"  prop="showAmount">
         ...
         <el-col :sm="6" >
           <el-button-group>
            ...
            <el-button type="" size="mini" >变更日志</el-button>
            <el-button type="" size="mini" icon="el-icon-download">导出</el-button>
          </el-button-group>
       
        </el-col>
          <el-col :sm="2" :offset="14">
    ...
    <div class="CM_content_center">
        <template>
          <el-table :data="tableData" border stripe style="width: 100%" id="TQ_table">
            ...
            <el-table-column prop="webName" label="汇率名称" align="center">
            </el-table-column>

             <el-table-column prop="webUrl" label='交易手续费%'  align="center">
            </el-table-column>
            <el-table-column prop="webUrl" label='Master交易手续费%'  align="center">
            </el-table-column>
            <el-table-column prop="webUrl" label='交易单笔手续费'  align="center">
            </el-table-column>
            <el-table-column prop="webUrl" label='保证金费率'  align="center">
            </el-table-column>
            ...
            <el-table-column prop="remark" label="保证金解冻周期（7天）"  align="center">
            </el-table-column>
            

            <el-table-column prop="createTime" label="提现周期（7天）" align="center" >
            </el-table-column>
            <el-table-column prop="createTime" label="提现条件" align="center" >
            </el-table-column>
