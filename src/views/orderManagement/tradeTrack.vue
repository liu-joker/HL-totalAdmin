      ...
      <div class="header" style='margin-bottom:20px;'>
        ...
        <el-col :sm="8">
          <el-form-item label="平台订单号:" prop="name"
                      :rules="[{ required: true, message: '请输入平台订单', trigger: 'blur' }]">
        <el-input v-model="form.orderNum" auto-complete="off" clearable class="input_440" :maxLength="50" size="small"></el-input>
        </el-form-item>
        </el-col>  
        <el-col :sm="8">
          <el-form-item label="交易网站:" prop="name"
                      :rules="[{ required: true, message: '请输入交易网站', trigger: 'blur' }]">
        <el-input v-model="form.orderWebSite" auto-complete="off" clearable class="input_440" :maxLength="50" size="small"></el-input>
        </el-form-item>
        </el-col>   
       </el-row>
       <el-row>
    ...
    <div class="CM_content_center">
        <template>
          <el-table :data="tableData" border stripe style="width: 100%" id="TQ_table">
            ...
            <el-table-column prop="webName" label="平台订单号" align="center">
            </el-table-column>

             <el-table-column prop="webUrl" label='进入系统时间'  align="center">
            </el-table-column>
            ...
            <el-table-column prop="remark" label="交易金额"  align="center">
            </el-table-column>
            

            <el-table-column prop="createTime" label="描述" align="center" >
            </el-table-column>
            <el-table-column prop="createTime" label="异常码" align="center" >
            </el-table-column>
            <el-table-column prop="createTime" label="异常原因" align="center" >
            </el-table-column>
