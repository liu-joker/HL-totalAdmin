    ...
    <div class="header" style='margin-bottom:20px;'>
      ...
      <el-form :model="form" ref="form">
        <el-row type="flex" class="row-bg">
          <el-col :sm="6">
            <el-form-item label="原始币种:" prop="name">
              <el-input v-model="form.name" auto-complete="off" clearable class="input_440" :maxLength="50"
                size="small"></el-input>
            </el-form-item>
          </el-col>
          <el-col :sm="6">
            <el-form-item label="目标币种:" prop="name">
              <el-input v-model="form.orderNum" auto-complete="off" clearable class="input_440" :maxLength="50"
                size="small"></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row type="flex" class="row-bg">
          <el-col :sm="6">
            <el-form-item label="中行汇率类型:" prop="name">
              <el-input v-model="form.name" auto-complete="off" clearable class="input_440" :maxLength="50"
                size="small"></el-input>
            </el-form-item>
          </el-col>
          <el-col :sm="6">
            <el-form-item label="偏移类型:" prop="name">
              <el-input v-model="form.orderNum" auto-complete="off" clearable class="input_440" :maxLength="50"
                size="small"></el-input>
            </el-form-item>
          </el-col>
            ...
            <el-col :sm="6">
              <el-form-item label="是否同步:" prop="name">
                <el-input v-model="form.orderNum" auto-complete="off" clearable class="input_440" :maxLength="50"
                  size="small"></el-input>
              </el-form-item>
            </el-col>
    ...
    <div class="CM_content_center">
      <template>
        <el-table :data="tableData" border stripe style="width: 100%" id="TQ_table">
          ...
          <el-table-column prop="webName" label="类型" align="center">
          </el-table-column>

          <el-table-column prop="webUrl" label='原始币种' align="center">
          </el-table-column>

          <el-table-column prop="webUrl" label='目标币种' align="center">
          </el-table-column>
          <el-table-column prop="webUrl" label='中行汇率类型' align="center">
          </el-table-column>
          <el-table-column prop="webUrl" label='中行汇率' align="center">
          </el-table-column>
           <el-table-column prop="webUrl" label='偏移类型' align="center">
          </el-table-column>
           <el-table-column prop="webUrl" label='偏移量' align="center">
          </el-table-column>
           <el-table-column prop="webUrl" label='平台汇率' align="center">
          </el-table-column>
           <el-table-column prop="webUrl" label='是否同步' align="center">
          </el-table-column>
           <el-table-column prop="webUrl" label='状态' align="center">
          </el-table-column>
           <el-table-column prop="webUrl" label='修改时间' align="center">
          </el-table-column>
           <el-table-column prop="webUrl" label='创建时间' align="center">
          </el-table-column>
