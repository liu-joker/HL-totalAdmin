    ...
    <div class="CM_content_center">
      <template>
        <el-table :data="tableData" border stripe style="width: 100%" id="TQ_table">
          ...
          <el-table-column prop="webName" label="操作类型" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="申请金额" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="处理费" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="手续费" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="申请币种" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="目标金额" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="目标币种" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="初审状态" align="center">
          </el-table-column>

          <el-table-column prop="webName" label="终审状态" align="center">
          </el-table-column>
