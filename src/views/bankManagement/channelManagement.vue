    ...
    <div class="CM_content_center">
        <template>
          <el-table :data="tableData" border stripe style="width: 100%" id="TQ_table">
            ...
            <el-table-column prop="webName" label="通道编号" align="center">
            </el-table-column>

             <el-table-column prop="webUrl" label='通道名称'  align="center">
            </el-table-column>
            ...
            <el-table-column prop="remark" label="状态"  align="center">
             ...
             <el-table-column prop="remark" label="支付方式"  align="center">
            </el-table-column>
