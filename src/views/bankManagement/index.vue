    ...
    <div class="CM_content_center">
        <template>
          <el-table :data="tableData" border stripe style="width: 100%" id="TQ_table">
            ...
            <el-table-column prop="webName" label="银行名称" align="center">
            </el-table-column>

             <el-table-column prop="webUrl" label='银行编号'  align="center">
            </el-table-column>
            ...
            <el-table-column prop="remark" label="主机"  align="center">
            </el-table-column>

             <el-table-column prop="remark" label="端口"  align="center">
            </el-table-column>

             <el-table-column prop="remark" label="使用代理"  align="center">
            </el-table-column>

             <el-table-column prop="remark" label="代理主机端口"  align="center">
            </el-table-column>
