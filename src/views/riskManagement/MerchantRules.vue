    ...
    <div class="CM_content_center">
        <template>
          <el-table :data="tableData" border stripe style="width: 100%" id="TQ_table">
            ...
            <el-table-column prop="webName" label="商户名称" align="center">
            </el-table-column>

             <el-table-column prop="webUrl" label='商户号'  align="center">
            </el-table-column>
            ...
            <el-table-column prop="createTime" label="集合规则" align="center" >
            </el-table-column>
