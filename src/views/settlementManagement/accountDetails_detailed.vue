    ...
    <div class="header" style='margin-bottom:20px;'>
      ...
      <el-form :model="form" ref="form">
        <el-row type="flex" class="row-bg">
          ...
          <el-col :sm="6">
            <el-form-item label="出入账类型:" prop="name">
              <el-select v-model="eventType" clearable placeholder="出入账类型" size="small" style="width: 200px">
    ...
    <div class="CM_content_center">
      <template>
        <el-table :data="tableData" border stripe style="width: 100%" id="TQ_table">
          ...
          <el-table-column prop="webName" label="出入账类型" align="center">
          </el-table-column>
          ...
          <el-table-column prop="webName" label="金额" align="center">
          </el-table-column>
